    ...
    q.awaitAll(function(errs, results) {
        ...
        venues.forEach(function(venue) {
            if (venue.all.length > 0) {
                mjml += '<mj-link font-size="25px" font-weight="bold" padding-top="10px" padding-bottom="3px" color="#000" target="_blank" href="' + venue.venueURL + '">' + venue.venue + '</mj-link>'
            ...
            venue.all.forEach(function(show, i) {
				...
				mjml += '<mj-button href="' + show.url + '" background-color="white" color="#D0057A" border="solid" padding="2px" padding-bottom="7px" inner-padding="5px 30px">tickets</mj-button>'
                mjml += '</mj-column>'
            })
        })
		mjml += '</mj-column>'
