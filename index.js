...
fs.readdir(__dirname + '/sources', function(err, dirs) {
    ...
    q.awaitAll(function(errs, results) {
		...
		mjml +=  '<mj-text font-weight="bold" font-size="26">Tonight</mj-text>';
		...
		mjml += '<mj-column width="100%">'
		mjml +=  '<mj-text font-weight="bold" font-size="26">' +moment().add(1, 'day').format('dddd')+'</mj-text>';
		mjml +=  '<mj-divider border-color="#D0057A"></mj-divider></mj-column>';
		venues.forEach(function(venue) {
		...
		mjml += '<mj-column width="100%">'
		mjml +=  '<mj-text font-weight="bold" font-size="26">' +moment().add(2, 'day').format('dddd')+'</mj-text>';
		mjml +=  '<mj-divider border-color="#D0057A"></mj-divider></mj-column>';
		venues.forEach(function(venue) {
		...
		mjml += '<mj-column width="100%">'
		mjml +=  '<mj-text font-weight="bold" font-size="26">' +moment().add(3, 'day').format('dddd')+'</mj-text>';
		mjml +=  '<mj-divider border-color="#D0057A"></mj-divider></mj-column>';
		venues.forEach(function(venue) {
		...
		mjml += '<mj-column width="100%">'
		mjml +=  '<mj-text font-weight="bold" font-size="26">' +moment().add(4, 'day').format('dddd')+'</mj-text>';
		mjml +=  '<mj-divider border-color="#D0057A"></mj-divider></mj-column>';
		venues.forEach(function(venue) {
		...
		mjml += '<mj-column width="100%">'
		mjml +=  '<mj-text font-weight="bold" font-size="26">' +moment().add(5, 'day').format('dddd')+'</mj-text>';
		mjml +=  '<mj-divider border-color="#D0057A"></mj-divider></mj-column>';
		venues.forEach(function(venue) {
		...
		mjml += '<mj-column width="100%">'
		mjml +=  '<mj-text font-weight="bold" font-size="26">' +moment().add(6, 'day').format('dddd')+'</mj-text>';
		mjml +=  '<mj-divider border-color="#D0057A"></mj-divider></mj-column>';
		venues.forEach(function(venue) {
		...
		mjml += '<mj-column width="100%">'
		mjml +=  '<mj-text font-weight="bold" font-size="26">' +moment().add(7, 'day').format('dddd')+'</mj-text>';
		mjml +=  '<mj-divider border-color="#D0057A"></mj-divider></mj-column>';
		venues.forEach(function(venue) {
