    ...
    q.awaitAll(function(errs, results) {
        ...
        venues.forEach(function(venue) {
            if (venue.all.length > 0) {
                mjml += '<mj-text font-size="22px" align="left" color="#000" font-weight="700">' + venue.venue + '</mj-text>'
            ...
            venue.all.forEach(function(show, i) {
				...
				mjml += '<mj-text><a href="' + show.url + '"><mj-button  background-color="white" color="#D0057A" border="solid" padding="2px" padding-bottom="5px" inner-padding="5px 30px"><mj-inline-links><mj-link color="#D0057A">'+buttonText+'<mj-link></mj-inline-links></mj-button></a></mj-text>'
            })
        })
		mjml += '</mj-column>'
