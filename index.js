    ...
    q.awaitAll(function(errs, results) {
        ...
        venues.forEach(function(venue) {
            if (venue.all.length > 0) {
                mjml += '<mj-button font-size="22px" align="left" background-color="#f45e43" color="white" href="' + venue.venueURL + '">' + venue.venue + '</mj-button>'
            ...
            venue.all.forEach(function(show, i) {
				...
				mjml += '<mj-button href="' + show.url + '" background-color="#f45e43" color="white" padding="2px" padding-bottom="5px" inner-padding="5px 30px">'+buttonText+'</mj-button>'
            })
        })
		mjml += '</mj-column>'
