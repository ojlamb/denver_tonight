    ...
    q.awaitAll(function(errs, results) {
        ...
        venues.forEach(function(venue) {
            ...
            venue.all.forEach(function(show, i) {
				...
				mjml += '<mj-button background-color="white" color="#D0057A" border="solid" padding="2px" padding-bottom="5px" inner-padding="5px 30px"><mj-inline-links><mj-link href="' + show.url + '">'+buttonText+'<mj-link></mj-inline-links></mj-button>'
            })
        })
		mjml += '</mj-column>'
