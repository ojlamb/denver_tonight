    ...
    q.awaitAll(function(errs, results) {
        ...
        venues.forEach(function(venue) {
            if (venue.all.length > 0) {
                mjml += '<mj-link align="left" font-size="24px" font-weight="bold" padding-top="2px" padding-bottom="4px" color="#000" target="_blank" href="' + venue.venueURL + '">' + venue.venue + '</mj-link>'
                mjml += '<mj-divider border-color="#01C4FF"></mj-divider>';
            }
            venue.all.forEach(function(show, i) {
                if (i > 0) mjml += '<mj-divider border-width=".5px" border-color="#01C4FF" width="88%" padding-bottom="7px"/>'
