    ...
    q.awaitAll(function(errs, results) {
        ...
        venues.forEach(function(venue) {
            if (venue.all.length > 0) {
                mjml += '<mj-link font-size="25px" font-weight="bold" color="#000" target="_blank" href="'> + venue.venueURL + '">' + venue.venue + '</mj-link>'
            ...
            venue.all.forEach(function(show, i) {
                ...
                mjml += '<mj-link font-weight="bold" padding-bottom="0px" color="#000" href="' + show.url + '" target="_blank">' + show.title + '</mj-link>'
